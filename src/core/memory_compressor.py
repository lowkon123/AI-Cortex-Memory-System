...
supporting efficient memory retrieval at different zoom levels.
"""
...
class MemoryCompressor:
    ...
    async def compress_to_l1(self, content: str) -> str:
        """Compress content into an L1 summary (Key Points).
    ...
    async def compress_to_l0(self, content: str) -> str:
        """Compress content into an L0 summary (Broad Overview).

        Args:
            content: Full content or L1 summary.
    ...
    def compress_batch(self, contents: list[str]) -> list[tuple[str, str]]:
        """Batch compress a list of memory contents into L0 and L1.
