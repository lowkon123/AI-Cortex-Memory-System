...
開發者最頭痛的，就是每當新 AI Agent 進入專案，都要燒一堆 Token 讓它「重新讀檔」。**Cortex 2.0 的存在，就是為了終結這種低效行為。**
